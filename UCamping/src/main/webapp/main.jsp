...
<body>
	<div class="body">
        ...
        <div class="item-list">
            ...
            <div class="img-slide">
              <div><a href=""><img class="item-img" src="${ path }/resources/images/item/item1.jpg">폴라리스 스틸쿨러<p class="price">123,000원</p></img></a></div>
              <div><a href=""><img class="item-img" src="${ path }/resources/images/item/item7.jpg">노마드 차박 텐트<p class="price">123,000원</p></img></a></div>
              <div><a href=""><img class="item-img" src="${ path }/resources/images/item/item3.jpg">리얼 릴렉스 체어<p class="price">123,000원</p></img></a></div>
              <div><a href=""><img class="item-img" src="${ path }/resources/images/item/item4.jpg">안티파이어 윈드스크린<p class="price">123,000원</p></img></a></div>
              <div><a href=""><img class="item-img" src="${ path }/resources/images/item/item5.jpg">웨일테일 불멍화로대<p class="price">123,000원</p></img></a></div>
              <div><a href=""><img class="item-img" src="${ path }/resources/images/item/item6.jpg">오핑 파라핀 랜턴 실버<p class="price">123,000원</p></img></a></div>
            </div>
            <div class="slide-btn">
        ...
        <div class="item-list">
          ...
          <div class="img-slide2">
            ...
            <div><a href=""><img class="item-img" src="${ path }/resources/images/item/item20.jpg">프로스트 아이스 쿨러<p class="price">123,000원</p></img></a></div>
            <div><a href=""><img class="item-img" src="${ path }/resources/images/item/item15.jpg">폴라리스 이그니스 블랙<p class="price">123,000원</p></img></a></div>
            ...
            <div><a href=""><img class="item-img" src="${ path }/resources/images/item/item16.jpg">오핑 파라핀 랜턴 실버<p class="price">123,000원</p></img></a></div>
          </div>
          <div class="slide-btn">
